...
TEST_CASE("Testing UTF8 To WSTR and back #1") {
    // Samples taken from:
...
TEST_CASE("Testing UTF8 To WSTR and back #2") {
    // German Part 1
...
TEST_CASE("Testing UTF8 To WSTR and back #3") {
    // German Part 2
...
TEST_CASE("Testing UTF8 To WSTR and back #4") {
    // German Part 2
...
TEST_CASE("Testing UTF8 To WSTR and back #5") {
    // Greek Part 1
...
TEST_CASE("Testing UTF8 To WSTR and back #6") {
    // Greek Part 2
...
TEST_CASE("Testing UTF8 To WSTR and back #7") {
    // English
...
TEST_CASE("Testing UTF8 To WSTR and back #8") {
    // Spanish
...
TEST_CASE("Testing UTF8 To WSTR and back #9") {
    // French
...
TEST_CASE("Testing UTF8 To WSTR and back #10") {
    // Irish Galeic
...
TEST_CASE("Testing UTF8 To WSTR and back #11") {
    // Hungarian
...
TEST_CASE("Testing UTF8 To WSTR and back #12") {
    // Icelandic
...
TEST_CASE("Testing UTF8 To WSTR and back #13") {
    // Japanese Hiragana
...
TEST_CASE("Testing UTF8 To WSTR and back #14") {
    // Japanese Katakana
...
TEST_CASE("Testing UTF8 To WSTR and back #15") {
    // Hebrew
...
TEST_CASE("Testing UTF8 To WSTR and back #16") {
    // Polish
...
TEST_CASE("Testing UTF8 To WSTR and back #17") {
    // Russian
...
TEST_CASE("Testing UTF8 To WSTR and back #18") {
    // Turkish
...
TEST_CASE("Testing string tokenizer #1") {
...
TEST_CASE("Testing string tokenizer #2") {
    std::string str = "  Hello  World! This    is a  sentence...   ";
    const auto tokens = ffw::getTokens(str, ' ');
    REQUIRE(tokens.size() == 6);
    REQUIRE(tokens.size() == ffw::getTokensNum(str, ' '));
...
TEST_CASE("Testing string tokenizer #3") {
    std::string str = " Hello  World! This is a  sentence...   ";
    const auto tokens = ffw::getTokens(str, "  ");
...
TEST_CASE("Testing string tokenizer #4") {
    std::string str = " Hello  World! This is a  sentence...  ";
    const auto tokens = ffw::getTokens(str, "  ");
...
TEST_CASE("Testing string tokenizer #5") {
    std::string str = "        ";
    const auto tokens = ffw::getTokens(str, "  ");
...
TEST_CASE("Testing string tokenizer #6") {
    std::string str = "         ";
    const auto tokens = ffw::getTokens(str, "  ");
...
TEST_CASE("Testing string tokenizer #7") {
...
TEST_CASE("Testing string tokenizer #8") {
